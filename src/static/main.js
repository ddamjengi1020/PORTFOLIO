...
eval("var topArrow = document.getElementById(\"jsTopArrow\");\n\nvar handleMoveTop = function handleMoveTop() {\n  window.scrollTo({\n    top: 0,\n    behavior: \"smooth\"\n  });\n};\n\ntopArrow.addEventListener(\"click\", handleMoveTop);\n\n//# sourceURL=webpack:///./assets/js/footer.js?");
...
eval("var body = document.querySelector(\"body\");\nvar headerUl = document.getElementById(\"jsHeaderContents\");\nvar about = document.getElementById(\"jsAbout\");\nvar skills = document.getElementById(\"jsSkills\");\nvar projects = document.getElementById(\"jsProjects\");\nvar footer = document.getElementById(\"jsFooter\");\nvar headerLi = document.querySelectorAll(\"li\");\nvar ABOUT = about.offsetTop;\nvar SKILLS = skills.offsetTop;\nvar PROJECTS = projects.offsetTop;\nvar FOOTER = footer.offsetTop;\nvar P = \"point\";\nvar leftWS = 10; // 오른쪽 여백\n\nvar topWS = 0; // 위쪽 여백\n\nvar scrollTop = 280; // 스크롤시 브라우저 위쪽과 떨어지는 거리\n\nvar scrollStart = 280; // 스크롤 시작위치\n\nvar activateSpeed = 15; //스크롤을 인식하는 딜레이 (숫자가 클수록 느리게 인식)\n\nvar scrollSpeed = 10; //스크롤 속도 (클수록 느림)\n\nvar timer;\n\nvar RefreshStaticMenu = function RefreshStaticMenu() {\n  var startPoint, endPoint;\n  startPoint = parseInt(document.getElementById(\"STATICMENU\").style.top, 10);\n  endPoint = Math.max(document.documentElement.scrollTop, document.body.scrollTop) + scrollTop;\n\n  if (endPoint < topWS) {\n    endPoint = topWS;\n  }\n\n  if (startPoint != endPoint) {\n    scrollAmount = Math.ceil(Math.abs(endPoint - startPoint) / 15);\n    document.getElementById(\"STATICMENU\").style.top = parseInt(document.getElementById(\"STATICMENU\").style.top, 10) + (endPoint < startPoint ? -scrollAmount : scrollAmount) + \"px\";\n    refreshTimer = scrollSpeed;\n  }\n\n  timer = setTimeout(function () {\n    return RefreshStaticMenu();\n  }, activateSpeed);\n};\n\nvar InitializeStaticMenu = function InitializeStaticMenu() {\n  document.getElementById(\"STATICMENU\").style.right = leftWS + \"px\"; //처음에 오른쪽에 위치. left로 바꿔도.\n\n  document.getElementById(\"STATICMENU\").style.top = document.body.scrollTop + scrollStart + \"px\";\n  RefreshStaticMenu();\n};\n\nvar removeClass = function removeClass() {\n  for (var i = 0; i < headerLi.length; i++) {\n    if (headerLi[i].className === P) {\n      headerLi[i].classList.remove(P);\n    }\n  }\n};\n\nvar handleScroll = function handleScroll() {\n  var scroll = Math.ceil(window.scrollY);\n  value = (scroll < ABOUT - 200) * 0 + (scroll >= ABOUT - 200 && scroll < SKILLS - 200) * 1 + (scroll >= SKILLS - 200 && scroll < PROJECTS - 200) * 2 + (scroll >= PROJECTS - 200 && scroll < FOOTER - 300) * 3 + (scroll >= FOOTER - 300) * 4;\n\n  switch (value) {\n    case 0:\n      removeClass();\n      break;\n\n    case 1:\n      removeClass();\n      headerLi[0].classList.add(P);\n      break;\n\n    case 2:\n      removeClass();\n      headerLi[1].classList.add(P);\n      break;\n\n    case 3:\n      removeClass();\n      headerLi[2].classList.add(P);\n      break;\n\n    case 4:\n      removeClass();\n      headerLi[3].classList.add(P);\n      break;\n\n    default:\n      break;\n  }\n};\n\nvar scrollMove = function scrollMove(value) {\n  window.scrollTo({\n    top: value,\n    behavior: \"smooth\"\n  });\n};\n\nvar handleScrollMove = function handleScrollMove(e) {\n  var event = e.target;\n  var target = (event === headerLi[0]) * 1 + (event === headerLi[1]) * 2 + (event === headerLi[2]) * 3 + (event === headerLi[3]) * 4;\n\n  switch (target) {\n    case 1:\n      scrollMove(ABOUT);\n      break;\n\n    case 2:\n      scrollMove(SKILLS);\n      break;\n\n    case 3:\n      scrollMove(PROJECTS);\n      break;\n\n    case 4:\n      scrollMove(FOOTER);\n      break;\n\n    default:\n      break;\n  }\n};\n\nheaderLi.forEach(function (li) {\n  li.addEventListener(\"click\", handleScrollMove);\n});\nwindow.addEventListener(\"scroll\", handleScroll);\nbody.onload = InitializeStaticMenu();\n\n//# sourceURL=webpack:///./assets/js/header.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"../node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! C:\\Users\\sillu\\Documents\\portfolio\\src\\assets\\js\\main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
